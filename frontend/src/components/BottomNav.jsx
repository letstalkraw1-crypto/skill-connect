...
import { Home, Mic2, User, TrendingUp, Bell } from 'lucide-react';
...
const BottomNav = () => {
  ...
  React.useEffect(() => {
    ...
    const interval = setInterval(fetch, 120000); // 2 minutes instead of 1
  ...
  const navItems = [
    ...
    { to: '/notifications', icon: Bell, label: 'Activity', badge: unreadCount > 0 ? unreadCount : null },
  ];
